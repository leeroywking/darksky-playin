...
precipintensityerror VARCHAR (10),
precipintensitymaxerror VARCHAR(10),
precipProbability VARCHAR(10),
precipprobabilityerror VARCHAR(10),
precipType VARCHAR(10),
temperatureHigh VARCHAR(10),
temperatureHighTime VARCHAR(10),
temperaturehigherror VARCHAR(10),
temperatureLow VARCHAR(10),
temperatureLowTime VARCHAR(10),
temperaturelowerror VARCHAR(10),
...
dewPoint VARCHAR(10),
dewpointerror VARCHAR(10),
humidity VARCHAR(10),
pressure VARCHAR(10),
pressureerror VARCHAR(10),
windSpeed VARCHAR(10),
windspeederror VARCHAR(10),
windGust VARCHAR(10),
windGustTime VARCHAR(10),
windBearing VARCHAR(10),
windbearingerror VARCHAR(10),
cloudCover VARCHAR(10),
cloudcovererror VARCHAR(10),
uvIndex VARCHAR(10),
...
temperatureminerror VARCHAR(10),
temperatureMax VARCHAR(10),
temperatureMaxTime VARCHAR(10),
temperaturemaxerror VARCHAR(10),
